...
export const HowItWorksSection = () => {
  return <section className="py-16 relative wood-texture text-western-parchment">
      <div className="container mx-auto max-w-6xl px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="bg-western-leather/80 border-4 border-western-accent/70 rounded-sm p-6 flex flex-col items-center text-center transform hover:scale-105 transition-transform hover:rotate-2 paper-texture">
            ...
            <p className="text-western-parchment font-western">Contribute more BOSC tokens to increase the bounty on outlaws you want brought to justice.</p>
          </div>
          ...
          <div className="bg-western-leather/80 border-4 border-western-accent/70 rounded-sm p-6 flex flex-col items-center text-center transform hover:scale-105 transition-transform hover:-rotate-2 paper-texture">
            ...
            <p className="text-western-parchment font-western">Help create a safer crypto frontier by spending bounties on action, justice measures, legal and social pressure.</p>
          </div>
        </div>
      </div>
