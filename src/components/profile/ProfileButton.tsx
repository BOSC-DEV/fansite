...
import { UserCircle2, LogOut, FileText, Coins } from "lucide-react";
  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent align="end" className="w-56 font-western">
        ...
        <DropdownMenuItem asChild>
          <Link to="/my-bounties" className="cursor-pointer text-western-parchment hover:text-western-parchment hover:bg-western-accent/40 transition-colors">
