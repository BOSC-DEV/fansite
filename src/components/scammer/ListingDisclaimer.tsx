...
export function ListingDisclaimer() {
  return (
    <div className="flex items-start p-4 bg-western-sand/30 rounded-lg border border-western-wood/30">
      <AlertTriangle className="h-5 w-5 text-western-accent mr-3 flex-shrink-0 mt-0.5" />
