      ...
      <TooltipProvider>
        <Tooltip>
          <TooltipTrigger asChild>
            <Button 
              asChild={isConnected} 
              className="w-full sm:w-auto bg-western-sand/70 hover:bg-western-wood text-western-wood hover:text-western-parchment flex items-center justify-center border border-western-wood/20"
              onClick={!isConnected ? () => {
